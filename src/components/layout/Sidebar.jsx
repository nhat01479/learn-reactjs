...
function Sidebar() {
    ...
    return (
        <>
           <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{ width: '280px', minHeight: 'calc(100vh - 60px)' }}>
                <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    <svg className="bi pe-none me-2" width={40} height={32}><use xlinkHref="#bootstrap" /></svg>
                    <span className="fs-4">Sidebar</span>
                    <button className="btn btn-primary" onClick={() => setShowLeftBar(false)}>ShowLeftBar</button>
                </a>
                <hr />
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item">
                        <a href="#" className="nav-link active" aria-current="page">
                        <i class="fas fa-home" width={16} height={16}></i>  
                            Home
                        </a>
                    </li>
                    <li>
